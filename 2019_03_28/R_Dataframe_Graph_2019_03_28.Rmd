...
iris <- read.csv(file = "~/Documents/TeacherAssistant/Bioninformatics/2019_03_28/Iris.csv", # file path
...
iris <- read.table(file = "~/Documents/TeacherAssistant/Bioninformatics/2019_03_28/Iris.tsv", # file path
                   stringsAsFactors = FALSE, # 只要有文字的那行，會直接轉為factor，因使我們要取消此功能
                   row.names = 1, # 告訴電腦第一列資料是 row name
                   header = TRUE,
                   sep = "\t", # 設定文件是使用什麼符號做為分隔
...
library(readxl)
iris_excel <- read_excel(path = "~/Documents/TeacherAssistant/Bioninformatics/2019_03_28/Iris.xlsm", # file path
...
``` {r error=T}
output_pdf_path <- "~/Documents/TeacherAssistant/Bioninformatics/2019_03_28/iris.pdf"
# save as pdf
...
output_tiff_path <- "~/Documents/TeacherAssistant/Bioninformatics/2019_03_28/iris.tiff"
# save as tiff
